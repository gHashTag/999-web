...
export const ApisData = [
  {
    href: "/apis/create-room/create-room",
    name: "Meeting/SDK Rooms",
    description: "This API can be used to create Meeting/SDK rooms.",
    icon: SquaresPlusIcon,
    pattern: {
      y: 22,
      squares: [[0, 1]],
  ...
  },
  {
    ...
    name: "IFrame Room",
    description: "This API can be used to create IFrame rooms.",
    icon: BookIcon,
    pattern: {
      y: 16,
      squares: [
  ...
  {
    href: "/apis/create-room/token-gated-room",
    name: "Token Gated Room",
    description: "This API can be used to create Token Gated rooms.",
    icon: PaperClipIcon,
    pattern: {
      y: 32,
      squares: [
