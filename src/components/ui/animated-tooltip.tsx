          ...
          <AnimatePresence mode="wait">
            {hoveredIndex === item.id && (
              ...
              >
                ...
                <div className="absolute left-10 w-[40%] z-30 -bottom-px bg-gradient-to-r from-transparent via-yellow-300 to-transparent h-px" />
                <div className="font-bold text-yellow-500 relative z-30 text-base">
                  {item.name}
                </div>
