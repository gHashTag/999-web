...
### Шаг 2: Управление аватарами. Главное меню.
...
### Шаг 3: Хозяин избушки:

Как записать встречу в цифровой аватар?

1. Нажимаем на огонь - это ваши цифровые аватары.
2. Выбираем аватар который будем использовать для встречи.
3. Отправляем приглашения тем, кто будет присутствовать на встрече.
4. Нажимаем кнопку Izbushka и открывается мини-приложение в Телеграм.
5. Присоединяемся к встрече нажимаем кнопку Join Now.
6. Нажимаем в основном меню гамбургер, откроется меню Options.
7. Для этого в меню Options нажмите кнопку Start Recording.
8. После завершения встречи нажмите кнопку Recording On и в появившемся меню нажмите кнопку Stop.
9. В основном меню нажмите красную кнопку Leave room и завершите сессию.
10. Через некоторое время от бота придет резюме, транскрибация всей встречи, список задач и делегирование задач исполнителям.
11. После этого со всеми задачами вы можете начать вести диалог в этом же боте.

### Шаг 4: Цифровой профиль аватара.
